 ...
 * positive partial transposition", Phys. Lett. A 232, 333 (1997), Section 4.2.
 * One of the original examples of PPT entanglement: PPT for every `aParam` in
 * [0, 1], separable only at the endpoints 0 and 1.
 *
 * See also D. Chruściński, A. Kossakowski, "Circulant states with positive
 * partial transpose", https://arxiv.org/abs/1108.2233, Eq. (2).
 */
...
/**
 * The 2x4 Horodecki state.
 *
 * @param options - see {@link HorodeckiOptions}.
 * @returns the 8x8 Horodecki density matrix.
 */
