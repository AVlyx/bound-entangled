  ...
  return (
    <>
      <p>
        ...
        graph-theoretic route to bound entanglement — whether a particular choice of edges gives
        an entangled or a PPT state is a combinatorial property of the graph.
      </p>
      ...
      <div className="doc-section">
        ...
        <p>
          ...
          state |<span className="math-var">i</span>, <span className="math-var">j</span>⟩. An
          edge joins two vertices and carries the normalized difference of their basis states:
        </p>
...
rho = grid_state(
    ...
    ((0, 0), (1, 0)),
      ...
      <div className="doc-section">
        <h2>Properties</h2>
        <p>
          Every grid state is a valid density matrix, since it is a uniform mixture of the
          rank-one projectors carried by the edges. Whether it is entangled or PPT depends on the
          graph: a single edge gives the projector onto |
          <span className="math-var">i, j</span>⟩ − |<span className="math-var">k, l</span>⟩,
          which is a maximally entangled (NPT) Bell-type state, as in the 2 × 2 preset above. Other
          edge sets can instead give a PPT state — a candidate for bound entanglement.
        </p>
        <p className="doc-cite">
          The four-edge cross-hatch pattern on C³ ⊗ C³ is one such PPT example; see{" "}
          <Link to="/states/c3-c3/cross-hatch">crossHatch()</Link>. The hyperedge generalization
          of this construction, used to build the C⁵ ⊗ C⁵ SN3 grid state, is documented at{" "}
