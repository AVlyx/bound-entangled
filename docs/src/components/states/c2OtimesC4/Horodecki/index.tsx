...
function Horodecki2by4() {
  ...
  return (
    <>
      <p>
        The <span className="math-var">C² ⊗ C⁴</span> Horodecki state was one of the first
        examples of a state that is positive under partial transpose (PPT) yet entangled. For
        every <span className="math-var">a</span> in [0, 1] it is PPT; for every{" "}
        <span className="math-var">a</span> in the open interval (0, 1) it is entangled, so no
        pure entanglement can be distilled from it by local operations and classical
        communication. It is separable only at the endpoints{" "}
      ...
      <div className="doc-section">
        ...
        <p>
          ...
          <span className="math-var">i</span> ∈ {"{0, 1}"} and{" "}
          <span className="math-var">j</span> ∈ {"{0, 1, 2, 3}"}, ordered as{" "}
...
rho = horodecki(0.5)  # 8x8 density matrix`}
      ...
      <div className="doc-section">
        ...
        <p>
          ...
          converse also holds — PPT implies separable — but this 2 ⊗ 4 state is a counterexample
          to that converse in higher dimension: it stays PPT for every{" "}
          <span className="math-var">a</span> yet is entangled on the interior of the range,
      ...
      <div className="doc-section">
        ...
        <p className="doc-cite">
          ...
          partial transposition", Phys. Lett. A 232, 333 (1997), Section 4.2.{" "}
