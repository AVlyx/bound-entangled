...
function Definition() {
  return (
    <DefinitionSection>
      ...
      <EquationBlock>
        <EquationLine>
          {"|\\psi_0\\rangle = |0\\rangle \\otimes (|0\\rangle - |1\\rangle)/\\sqrt2"}
        </EquationLine>
        <EquationLine>
          {"|\\psi_1\\rangle = (|0\\rangle - |1\\rangle) \\otimes |2\\rangle/\\sqrt2"}
        </EquationLine>
        <EquationLine>
          {"|\\psi_2\\rangle = |2\\rangle \\otimes (|1\\rangle - |2\\rangle)/\\sqrt2"}
        </EquationLine>
        <EquationLine>
          {"|\\psi_3\\rangle = (|1\\rangle - |2\\rangle) \\otimes |0\\rangle/\\sqrt2"}
        </EquationLine>
        <EquationLine>
          {
      ...
      <p>
        ...
        9-dimensional space <Latex>{`\\mathbb{C}^3 \\otimes \\mathbb{C}^3`}</Latex>, leaving a
        4-dimensional orthogonal complement. The bound entangled state is the uniform mixture over
        that complement, built by the shared <span className="math-op">upb</span> construction:
      </p>
