  ...
  return (
    <DefinitionSection>
      ...
      <EquationBlock>
        ...
        <EquationLine>{"|\\psi_1\\rangle = \\tfrac{1}{\\sqrt2}(|12\\rangle + |21\\rangle)"}</EquationLine>
        <EquationLine>
          {"|\\psi_2\\rangle = \\tfrac{1}{\\sqrt3}(|00\\rangle + |11\\rangle - |22\\rangle)"}
        </EquationLine>
        <EquationLine>{"|\\psi_3\\rangle = m1|01\\rangle + m2|10\\rangle + m3|11\\rangle + m3|22\\rangle"}</EquationLine>
        <EquationLine>
